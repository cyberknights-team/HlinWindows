...
namespace hlin_v01
{
    ...
    public sealed partial class lock_form : Page
    {
        ...
        private async void upload_Click(object sender, RoutedEventArgs e)
        {
                ...
                if ((verify1 != "") && (verify2 != ""))
                {
                    if (type != "")
                    {
                        ...
                        try
                        {
                            ...
                            double size = 25.0 * 10 * 10 * 10 * 10 * 10 * 10 * 10;
                            ...
                            if (file != null)
                            {
                                ...
                                {
                                    error += "Files has to be less than 250mb..";
                                    popup();
                                }
                            }
                        }
            ...
            {
                error += "WHOOPS! You are not connected to the internet! \nPlease check your internet connection and try again...";
                popup();
            }
        }
        ...
        private async Task<string> generate_upload(StorageFile file)
        {
            ...
            blob += type;
            blob += rowkey;
            loading_text.Text = "Getting Container ...";
                         ...
                         { 
                             if (files.Count <= 10)
                             {
                                 ...
                                 foreach (StorageFile file in files)
                                 {
                                     ...
                                     if (properties.Size > size)
                                     {
                                         error = "Every files has to be less than 250mb..";
                                         popup();
                                         dec = false;
                                         break;
                                     }
                             ...
                             {
                                 error += "Only 10 files is allowed per one multiple upload";
                                 popup();
                             }
                         }
                         else
        ...
        private void slider_ValueChanged(object sender, RangeBaseValueChangedEventArgs e)
        {
            try
            {
                slider_text.Text = "Range (In metres):" + slider.Value.ToString();
            }
            catch
            {
